...
def generate_response(question: str, documents):
    ...
    # Format for Anthropic (system message separate from user messages)
    ...
    return call_anthropic(system_message, messages)
...
def call_anthropic(system_message: str, messages: List[dict]):
    # Format system message for Anthropic API
    system_param = [{"type": "text", "text": system_message}] if system_message else None
